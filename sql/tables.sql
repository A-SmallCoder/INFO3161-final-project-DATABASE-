...
create table user_profile(profile_id in not null auto_increment, profile_pic varchar(255)
...
create table comment(cid int auto_increment, comment_text varchar(500),user_id int,post_id int
foreign key(user_id) references User(id) on update cascade on delete cascade,
